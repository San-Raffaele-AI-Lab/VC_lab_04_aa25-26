...
void do_columbia_peak(void)
  {
  string indir=ROOT_DIR / "pano/columbia/";
  string outdir=ROOT_DIR / "output/columbia/";
...
void do_rainier(void)
  {
  string indir=ROOT_DIR / "pano/rainier/";
  string outdir=ROOT_DIR / "output/rainier/";
...
void do_field(void)
  {
  string indir=ROOT_DIR / "pano/field/";
  string outdir=ROOT_DIR / "output/field/";
...
void do_helens(void)
  {
  string indir=ROOT_DIR / "pano/helens/";
  string outdir=ROOT_DIR / "output/helens/";
...
void do_sun(void)
  {
  string indir=ROOT_DIR / "pano/sun/";
  string outdir=ROOT_DIR / "output/sun/";
...
void do_white_wall(void)
  {
  string indir=ROOT_DIR / "pano/wall/";
  string outdir=ROOT_DIR / "output/wall/";
...
void do_cse_glade(void)
  {
  string indir=ROOT_DIR / "pano/cse/";
  string outdir=ROOT_DIR / "output/cse/";
